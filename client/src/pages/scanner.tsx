    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Scan QR codes to view and update item details
        </p>
      </div>
        ...
        <Card className="shadow-sm">
          <CardContent className="p-6">
            <div className="text-center">
              <div
                className={`w-64 h-64 mx-auto mb-6 rounded-lg flex items-center justify-center relative overflow-hidden ${
